...
def show_cam_on_image(img, mask,img_org,image_savepath):
...
# this function is for read image,the input is directory name
    ...
    save_dir_name='E:/imagenet_val_gcam'
    for filename in os.listdir(directory_name):
        # img = cv2.imread(directory_name + "/" + filename)
        image_path =directory_name + "/" + filename
        image_savepath = save_dir_name + "/" + filename
        grad_cam = GradCam(model, target_layer_names=["layer4"], use_cuda='')
        ...
        show_cam_on_image(img, mask, img_org, image_savepath)



    # grad_cam = GradCam(model ,target_layer_names = ["layer4"], use_cuda='')
    # image_path='E:/imagenet_val/ILSVRC2012_val_00000002.JPEG'
    # image_savepath='E:/imagenet_val_gcam/ILSVRC2012_val_00000002.JPEG'
    # img = cv2.imread(image_path, 1)
    # img_org=img
    # img = np.float32(cv2.resize(img, (224, 224))) / 255
    # input = preprocess_image(img)
